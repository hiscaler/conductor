...
创意方向选择不是让用户写更多内容，而是让用户从 3-5 个已经整理好的具体方向里选一个。用户只需要回复数字，例如 `1`；不想判断时回复“自动选择”。如果商品是强规格标准品、用户已经给了明确方向，或用户要求直接输出，系统会跳过选择菜单，但仍会形成并记录可执行创意策略。
...
- [创意方向选择流程](./workflows/creative-direction-selection.md)：内容生产前的数字创意选择和自动选择规则。
